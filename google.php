...
define('GOOGLE_CLIENT_ID', '823438893202-umoh7nlv9mtgalotudq6p99mie4r4iaj.apps.googleusercontent.com'); 
define('GOOGLE_CLIENT_SECRET', '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'); 
define('GOOGLE_OAUTH_SCOPE', 'https://www.googleapis.com/auth/drive'); 
define('GOOGLE_REDIRECT_URI', 'http://localhost/iprc/index.php');

// Google OAuth URL 
$googleOauthURL = 'https://accounts.google.com/o/oauth2/auth?scope=' . urlencode(GOOGLE_OAUTH_SCOPE) . '&redirect_uri=' . GOOGLE_REDIRECT_URI . '&response_type=code&client_id=' . GOOGLE_CLIENT_ID . '&access_type=online'; 
